// =========================================================================
// {{ cookiecutter.plugin_name }} — Reference CPEX WASM plugin in Rust
// =========================================================================
//
...
use contextforge::cpex::types::{LogLevel, ManifestInfo, PluginError};
...
impl Guest for Component {
    fn init(config_json: String) -> Result<(), PluginError> {
        ...
        log_info(&format!(
            "{{ cookiecutter.plugin_slug }} initialized at {}ms",
            clock::now_millis()
        ));
        Ok(())
    }
    ...
    fn manifest() -> ManifestInfo {
        ManifestInfo {
            name: "{{ cookiecutter.plugin_slug }}".into(),
            version: "{{ cookiecutter.version }}".into(),
    ...
    fn shutdown() {
        log_info("{{ cookiecutter.plugin_slug }} shutting down");
    }
}
