    ...
    pub mod example {
        pub mod plugin {
            ...
            pub mod policy {
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_make_http_request_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let len0 = arg1;
                    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
                    let result1 = T::make_http_request(_rt::string_lift(bytes0));
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_make_http_request<T: Guest>(arg0: *mut u8) {
                    let l0 = *arg0.add(0).cast::<*mut u8>();
                    let l1 = *arg0
                        .add(::core::mem::size_of::<*const u8>())
                        .cast::<usize>();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn _export_get_env_var_cabi<T: Guest>(
                    arg0: *mut u8,
                    arg1: usize,
                ) -> *mut u8 {
                    #[cfg(target_arch = "wasm32")] _rt::run_ctors_once();
                    let len0 = arg1;
                    let bytes0 = _rt::Vec::from_raw_parts(arg0.cast(), len0, len0);
                    let result1 = T::get_env_var(_rt::string_lift(bytes0));
                    let ptr2 = (&raw mut _RET_AREA.0).cast::<u8>();
                    let vec3 = (result1.into_bytes()).into_boxed_slice();
                    let ptr3 = vec3.as_ptr().cast::<u8>();
                    let len3 = vec3.len();
                ...
                #[doc(hidden)]
                #[allow(non_snake_case)]
                pub unsafe fn __post_return_get_env_var<T: Guest>(arg0: *mut u8) {
                    let l0 = *arg0.add(0).cast::<*mut u8>();
                    let l1 = *arg0
                        .add(::core::mem::size_of::<*const u8>())
                        .cast::<usize>();
                ...
                pub trait Guest {
                    ...
                    fn make_http_request(url: _rt::String) -> _rt::String;
                    fn get_env_var(var_name: _rt::String) -> _rt::String;
                }
                #[doc(hidden)]
                macro_rules! __export_example_plugin_policy_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        #[unsafe (export_name =
                        "example:plugin/policy#make-http-request")] unsafe extern "C" fn
                        export_make_http_request(arg0 : * mut u8, arg1 : usize,) -> * mut
                        u8 { unsafe { $($path_to_types)*::
                        _export_make_http_request_cabi::<$ty > (arg0, arg1) } } #[unsafe
                        (export_name =
                        "cabi_post_example:plugin/policy#make-http-request")] unsafe
                        extern "C" fn _post_return_make_http_request(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*::
                        __post_return_make_http_request::<$ty > (arg0) } } #[unsafe
                        (export_name = "example:plugin/policy#get-env-var")] unsafe
                        extern "C" fn export_get_env_var(arg0 : * mut u8, arg1 : usize,)
                        -> * mut u8 { unsafe { $($path_to_types)*::
                        _export_get_env_var_cabi::<$ty > (arg0, arg1) } } #[unsafe
                        (export_name = "cabi_post_example:plugin/policy#get-env-var")]
                        unsafe extern "C" fn _post_return_get_env_var(arg0 : * mut u8,) {
                        unsafe { $($path_to_types)*:: __post_return_get_env_var::<$ty >
                        (arg0) } } };
                    };
                }
                #[doc(hidden)]
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xbd2\x01A\x02\x01A\x17\
...
B\x08\x01@\x02\x04jsons\x03keys\0s\x04\0\x09check-key\x01\0\x01@\x02\x08filename\
s\x07contents\0s\x04\0\x0bcreate-file\x01\x01\x01@\x01\x03urls\0s\x04\0\x11make-\
http-request\x01\x02\x01@\x01\x08var-names\0s\x04\0\x0bget-env-var\x01\x03\x04\0\
\x15example:plugin/policy\x05\x0f\x04\0\x15example:plugin/plugin\x04\0\x0b\x0c\x01\
