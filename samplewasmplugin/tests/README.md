...
A WebAssembly Component Model plugin for CPEX
...
That produces `build/samplewasmplugin.wasm` and updates
...
plugins:
  - name: "samplewasmplugin"
    ...
    priority: 150
    config:
      manifest_path: "/path/to/samplewasmplugin/plugin-manifest.yaml"
...
Shriti — pick an SPDX-compatible license.
